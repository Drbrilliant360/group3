...
$sql = "SELECT stories.StoryID, stories.StoryContent, stories.StoryImage, stories.StoryTime, user.username AS story_username, user.photo AS story_photo
        FROM stories
                        ...
                        <div class="bg-white rounded-xl shadow-sm md:p-4 p-2 space-y-4 text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <div class="flex items-center md:gap-3 gap-1">
                                <div class="flex-1 bg-slate-100 hover:bg-opacity-80 transition-all rounded-lg cursor-pointer dark:bg-dark3" uk-toggle="target: #create-status"> 
                                    <div class="py-2.5 text-center dark:text-white"> post anything for today</div>
                                </div>
                ...
                <div class="flex-1"> 
                    ...
                    <div class="box p-5 px-6">
                        ...
                        <div class="flex items-baseline justify-between text-black dark:text-white">
                            <h3 class="font-bold text-base"> GROUP MEMBERS</h3>
                        ...
                        <div class="side-list">
                            ...
                            <div class="side-list-item">
                                ...
                                <div class="flex-1">
                                    <a href="timeline.html"><h4 class="side-list-title"> GERALD </h4></a>
                            ...
                            <div class="side-list-item">
                                ...
                                <div class="flex-1">
                                    <a href="timeline.html"><h4 class="side-list-title"> NOLLY </h4></a>
                            ...
                            <div class="side-list-item">
                                ...
                                <div class="flex-1">
                                    <a href="timeline.html"><h4 class="side-list-title"> IRENE</h4></a>
                                    <div class="side-list-info"> 125k Following </div>
                                </div>
                                <button class="button bg-primary-soft text-primary dark:text-white">follow</button>
                            </div>
                            ...
                            <div class="side-list-item">
                                ...
                                <div class="flex-1">
                                    <a href="timeline.html"><h4 class="side-list-title"> KHADIJA </h4></a>
                            ...
                            <div class="side-list-item">
                                ...
                                <div class="flex-1">
                                    <a href="timeline.html"><h4 class="side-list-title"> ANNA</h4></a>
                                    <div class="side-list-info"> 320k Following </div>
                                </div>
                                <button class="button bg-primary-soft text-primary dark:text-white">follow</button>
                            </div>  
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2">
                        ...
                        <div class="flex justify-between text-black dark:text-white">
                            <h3 class="font-bold text-base"> courses in IFM</h3>
                            <button type="button"> <ion-icon name="sync-outline" class="text-xl"></ion-icon> </button>
                        </div>
                        ...
                        <div class="space-y-3.5 capitalize text-xs font-normal mt-5 mb-2 text-gray-600 dark:text-white/80">
                            <a href="#">
                                <div class="flex items-center gap-3 p"> 
                                    ...
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-black dark:text-white text-sm">BCS</h4>
                            ...
                            <a href="#" class="block">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-black dark:text-white text-sm"> BIT</h4>
                            ...
                            <a href="#" class="block">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-black dark:text-white text-sm">  BAC</h4>
                            ...
                            <a href="#" class="block">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-black dark:text-white text-sm"> BEF </h4>
...
<!-- ===========END POST============ -->
    ...
    <div class="hidden lg:p-20" id="create-story" uk-modal="">
        <div class="uk-modal-dialog tt relative overflow-hidden mx-auto bg-white p-7 shadow-xl rounded-lg md:w-[520px] w-full dark:bg-dark2">
            ...
            <form action="upload-story.php" method="POST" enctype="multipart/form-data">
                <div class="space-y-5 mt-3 p-2">
                    <textarea class="w-full !text-black placeholder:!text-black !bg-white !border-transparent focus:!border-transparent focus:!ring-transparent !font-normal !text-xl dark:!text-white dark:placeholder:!text-white dark:!bg-slate-800" name="story_content" rows="6" placeholder="Share your story..."></textarea>
                </div>
                <div class="space-y-5 mt-3 p-2">
                    <input type="file" name="story_image" accept="image/*" class="flex items-center gap-1.5 bg-sky-50 text-sky-600 rounded-full py-1 px-2 border-2 border-sky-100 dark:bg-sky-950 dark:border-sky-900">
                </div>
                <div class="p-5 flex justify-between items-center">
                    ...
                    <button type="submit" name="submit_story" class="button bg-blue-500 text-white py-2 px-12 text-[14px]">Post Story</button>
                </div>
            </form>
        </div>
    </div>

    <!-- HTML for the replay button and comment section -->
    ...
    <script>
        ...
        // JavaScript to toggle the comment section
        ...
        document.getElementById('submitComment').addEventListener('click', function() {
            ...
            if (commentText) {
                ...
                // Here you can add code to handle the comment submission, e.g., send it to the server
                document.getElementById('commentText').value = ''; // Clear the textarea
                document.getElementById('commentSection').style.display = 'none'; // Hide the comment section
            } else {
